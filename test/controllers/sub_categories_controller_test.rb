...
class SubCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create sub_category" do
    assert_difference('SubCategory.count') do
      post :create, sub_category: { category_id: @sub_category.category_id, name: @sub_category.name, no_of_stock: @sub_category.no_of_stock, stock_required: @sub_category.stock_required }
    end
  ...
  test "should update sub_category" do
    patch :update, id: @sub_category, sub_category: { category_id: @sub_category.category_id, name: @sub_category.name, no_of_stock: @sub_category.no_of_stock, stock_required: @sub_category.stock_required }
    assert_redirected_to sub_category_path(assigns(:sub_category))
  end
